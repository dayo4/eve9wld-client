...
<template>
	<GlobalWrapper>
		<template #WrapperTitle> GALLERY </template>

		<!-- Filter -->
		<template #WrapperHead>
			<Dropdown ownID="PrdCat" class="mr-1 btnl bg-trans-3 br3">
				<!-- slots -->
		...
		<template #WrapperBody>
			<section
				class="TilesContainer flex wrap j-c-center md-j-c-start px-1"
			>
				<div
			...
			<section class="flex j-c-center">
				<div class="Pagins xs12 sm11 md8">
					...
					<button
						class="Nums btn bg-white"
						v-for="i in pagin.pages"
						:key="i"
					>
						<span
							@click="switchPage(i)"
					...
					>
						...
						<span
							class="Icon icon-angle-double-right font-6"
						></span>
					</button>
				</div>
			</section>
