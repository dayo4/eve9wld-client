    ...
    <section class="flex j-c-center wrap md-nowrap mt-9">
      ...
      <div class="xs11 md8 mb-5">
        ...
        <section v-if="cart.length === 0" class="text-center t-blue-grey mt-3">
          ...
          <div class="flex j-c-center">
            ...
            >
              <i class="icon-search-2 mr-2"></i>Check Popular Items
            </button>
          </div>
        </section>
      </div>
      ...
      <div class="xs11 md3 ml-3 text-center">
        <div class="p-2 mb-3 br2 bg-grey-4">
          ...
          <p class="t-blue-grey--1 font-6 bold-3">USD - ${{ cart_total }}</p>
          ...
          <i class="t-grey--1 font-2">Price displayed excludes sales tax</i>
        </div>
