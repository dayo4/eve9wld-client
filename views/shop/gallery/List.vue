...
<Container ownID="MC-Gall">
    ...
    <section class="TilesContainer flex wrap j-c-center md-j-c-start px-3">
        <div class="px-3 mb-6 xs12 sm8 md4 noselect" v-for="(item, i) in products" :key="i">
            <article class="Tiles">
                <section class="Img">
                    <img :title="item.name" :alt="item.name" :src="item.images[0].src" draggable="false" />
                </section>
                <section class="Details">
                    ...
                    <div class="Body t-blue-grey--1">
                        ...
                        <section class="Action">
                            <button @click="viewProduct(item.slug)" class="btn bg-white t-cyan--3 mr-2 px-2 py-0 b2">
                                View
                            </button>
                            <button @click="addToCart(item)" class="btn bg-white t-green--3 font-8 px-2 py-0 b2">
