...
export default Vue.extend({
  components: {
    ...
    System: () =>
      import(
        /* webpackChunkName: "minimizer" */ "@/components/notifications/tabs/System.vue"
      ),
    Dropdown: () =>
      import(
        /* webpackChunkName: "dropdown" */ "@/components/GlobalComponents/utils/Dropdown.vue"
      ),
    Comments: () =>
      import(
        /* webpackChunkName: "comments" */ "@/components/posts/comment/Comments.vue"
      )
  },
