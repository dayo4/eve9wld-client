...
const routes = [
  ...
  },
  {
    ...
    name: "privacy",
    component: () =>
      import("@/views/pages/Privacy.vue").then(m => m.default || m)
  },
  // {
  //   path: "/services",
  //   name: "services",
  ...
  // },
  {
    ...
    name: "401",
    component: () =>
      import(/* webpackPrefetch: true */ "@/views/pages/ERRORS/401.vue").then(
        m => m.default || m
      )
  },
  {
    ...
    name: "404",
    component: () =>
      import(/* webpackPrefetch: true */ "@/views/pages/ERRORS/404.vue").then(
        m => m.default || m
      )
  }
];
